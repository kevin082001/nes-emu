            ...
            while ((rom[pc] & 0xFF) != 0x00) {
                ...
                switch (opcode) {
                    ...
                    case 0x00, 0x06, 0x10, 0x16, 0x18, 0x21, 0x24, 0x25, 0x29, 0x30,
                         0x31, 0x35, 0x41, 0x45, 0x49, 0x50, 0x51, 0x55, 0x61, 0x65,
                         0x69, 0x70, 0x71, 0x75, 0x81, 0x84, 0x85, 0x86, 0x90, 0x91,
                         0x94, 0x95, 0x96, 0xA0, 0xA2, 0xA4, 0xA9, 0xB0, 0xB4, 0xC0,
                         0xC1, 0xC4, 0xC5, 0xC6, 0xC9, 0xD0, 0xD1, 0xD5, 0xD6, 0xE0,
                         0xE4, 0xE6, 0xF0, 0xF6:
                        //These instructions are 2 bytes wide
                        cpu.executeInstruction(opcode, rom[pc + 1]);
                        break;
                    case 0x0E, 0x1E, 0x20, 0x2C, 0x2D, 0x39, 0x3D, 0x4C, 0x59, 0x5D,
                         0x6C, 0x6D, 0x79, 0x7D, 0x8C, 0x8D, 0x8E, 0x99, 0x9D, 0xAC,
                         0xAD, 0xAE, 0xBC, 0xBE, 0xCC, 0xCD, 0xCE, 0xD9, 0xDD, 0xDE,
                         0xEC, 0xEE, 0xFE:
